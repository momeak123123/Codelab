...
public class two_static_state  extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.view5)
    View view5;
    ...
    /*
        ...
        headtxt.setText("智能检测");
        headtxts.setText("基于android官方自带的人脸识别类FaceDetector");
    ...
    public static two_static_state newInstance() {
        Bundle args = new Bundle();
        two_static_state fragment = new two_static_state();
