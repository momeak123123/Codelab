...
public class there_static_state extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.view5)
    View view5;
    ...
    /*
        ...
        headtxt.setText("智能识别");
        headtxts.setText("基于android等原生的智能识别");
        imbtxt1.setText("javacv对比");
        imbtxt2.setText("像素值对比");
        imbtxt3.setText("直方图对比");
        imbtxt4.setText("欧氏距离对比");
        imbtxt5.setText("均值Hash算法对比");
        imbtxt6.setText("pHash算法对比");
    ...
    public static there_static_state newInstance() {
        Bundle args = new Bundle();
        there_static_state fragment = new there_static_state();
