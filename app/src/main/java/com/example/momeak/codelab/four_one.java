...
public class four_one extends Fragment {
    ...
    /*
        ...
        headtxt.setText("静态测试");
        headtxts.setText("基于android的静态测试");
    ...
    public static four_one newInstance() {
        Bundle args = new Bundle();
        four_one fragment = new four_one();
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.imb8:
                break;
            case R.id.imb7:
                Intent intent7 = new Intent(getContext(), four_statics_one.class);
                intent7.putExtra("id", 46);
                startActivity(intent7);
                break;
            case R.id.imb6:
                Intent intent6 = new Intent(getContext(), four_statics_one.class);
                intent6.putExtra("id", 45);
                startActivity(intent6);
                break;
            case R.id.imb5:
                Intent intent5 = new Intent(getContext(), four_statics_one.class);
                intent5.putExtra("id", 44);
                startActivity(intent5);
                break;
            case R.id.imb4:
                Intent intent4 = new Intent(getContext(), four_statics_one.class);
                intent4.putExtra("id", 43);
                startActivity(intent4);
                break;
            case R.id.imb3:
                Intent intent3 = new Intent(getContext(), four_statics_one.class);
                intent3.putExtra("id", 42);
                startActivity(intent3);
                break;
            case R.id.imb2:
                Intent intent2 = new Intent(getContext(), four_statics_one.class);
                intent2.putExtra("id", 41);
                startActivity(intent2);
                break;
            case R.id.imb1:
                Intent intent1 = new Intent(getContext(), four_statics_one.class);
