...
public class two_dynamic_condition extends Fragment {
    Unbinder unbinder;
    @BindView(R.id.view5)
    View view5;
    ...
    /*  switchs.setVisibility(View.GONE);
        ...
        headtxt.setText("动态检测");
        headtxts.setText("基于opencv的动态检测");
        imbtxt1.setText("动态人脸检测");
        imbtxt2.setText("动态侧脸检测");
    ...
    public static two_dynamic_condition newInstance() {
        Bundle args = new Bundle();
        two_dynamic_condition fragment = new two_dynamic_condition();
